...
export class AddReceiveEmailsCreatorField1753726864037
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ALTER TABLE creator ADD COLUMN receive_emails BOOLEAN DEFAULT TRUE;
      `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ALTER TABLE creator DROP COLUMN receive_emails;
      `);
