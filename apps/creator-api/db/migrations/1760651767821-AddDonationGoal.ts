...
export class AddDonationGoal1760651767821 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query(`
        ...
        SELECT
          ...
          (
            SELECT COALESCE(u.display_name, du.from_address)
        ...
        LEFT JOIN creator_donations d
          ON d.id = dg."creator_donations_id"
        GROUP BY
          g.id,
          g.name,
          g.target_amount,
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query(`DROP TABLE "donation_goal_donations_creator_donations"`);
