...
export class AddBadWords1748967010401 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP VIEW IF EXISTS creator_profile_view;
    `);

    await queryRunner.query(`ALTER TABLE donation_parameters
      ADD COLUMN custom_bad_words TEXT[] DEFAULT '{}'`);
