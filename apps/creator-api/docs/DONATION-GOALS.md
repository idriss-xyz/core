...
Donation Goals enable streamers1 to set fundraising targets for specific time periods. The system tracks progress towards these goals by automatically associating incoming donations with active goals.
