...
module.exports = {
  ...
  options: {
    ...
    exclude: {
      /* path: an array of regular expressions in strings to match against */
      path: ['types/*', 'migrations/*', 'prettier.*'],
    },
    ...
    */
    ...
    /* List of module systems to cruise.
       ...
       module systems it knows of. It's the default because it's the safe option It might come at a performance penalty, though.
...
// generated: dependency-cruiser@16.2.4 on 2024-03-21T07:08:28.023Z
