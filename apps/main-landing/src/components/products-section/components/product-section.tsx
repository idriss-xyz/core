...
export const ProductSection = ({
  ...
  return (
    <div className={classes('relative flex size-full bg-mint-100', className)}>
      <div
        className={classes(
          'flex size-full flex-col bg-[linear-gradient(114deg,_#022B1E_34.81%,_#079165_123.57%)] px-4 transition-[border-radius] duration-150 will-change-[border-radius]',
          'lg:px-[120px] lg:pt-[80px] lg:[@media(max-height:1100px)]:pt-[30px]',
        )}
        style={style}
      >
        <div
        ...
        >
          <div className="flex flex-col items-start gap-[64px] md:gap-10 lg:[@media(max-height:1100px)]:gap-[50px]">
              ...
              <div className="z-1 overflow-hidden">
                <h2
                  className={classes(
                    ...
                    'md:text-display4',
                    'lg:pt-0 lg:[@media(max-width:1540px)]:[@media(max-height:1000px)]:text-display4 [@media(min-width:1541px)]:text-display2',
                    headerClassName,
              ...
              <div className="z-1 overflow-hidden">
                <p
                  className={classes(
                    ...
                    'lg:w-[60%] [@media(min-width:1541px)]:text-body2',
                    fadeOut && 'translate-y-[-120%]',
                  )}
                >
                  {description}
            ...
            <div className="z-1 mx-auto mt-[-80px] overflow-hidden md:mt-0">
              <div
                className={classes(
