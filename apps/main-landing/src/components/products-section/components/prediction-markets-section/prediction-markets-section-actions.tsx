          ...
          render={({ field }) => {
            return (
              ...
              <input
                type="email"
                className={classes(
                  'flex text-body4 md:w-1/2 w-full flex-[1_0_0] items-center rounded-[12px] px-3 py-2 shadow-[0_0_0_4px_rgba(242,242,242,0.14)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 lg:w-[290px]',
