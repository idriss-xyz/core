...
const CSP = [
  ...
  `connect-src 'self' https://nftdata.parallelnft.com https://cdn.jsdelivr.net https://unpkg.com wss://creators-api.idriss.xyz https://api.mainnet.abs.xyz https://api.avax.network/ext/bc/C/rpc https://api.roninchain.com/rpc https://ethereum-rpc.publicnode.com https://base-rpc.publicnode.com https://mainnet.base.org https://get.geojs.io http://ip-api.com https://auth.privy.io https://creators-api.idriss.xyz https://core-staging-4c69.up.railway.app https://id.twitch.tv https://api.twitch.tv https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://explorer-api.walletconnect.com https://pulse.walletconnect.org wss://relay.walletconnect.com wss://relay.walletconnect.org wss://www.walletlink.org https://*.rpc.privy.systems https://api.web3modal.org${DEV ? ' http://localhost:* ws://localhost:*' : ''}`,
