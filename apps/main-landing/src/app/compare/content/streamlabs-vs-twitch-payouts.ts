...
Streamlabs donations go directly to you minus [PayPal fees (2.9% + $0.30)](https://www.paypal.com/us/webapps/mpp/merchant-fees). A $5 donation nets you $4.55. That's 91% versus Twitch's 50%. The math strongly favors direct donations.`,
    },
    {
      title: 'Are Twitch Bits Better Than Donations?',
      content: `No. Twitch takes roughly 30% when viewers buy Bits. A viewer spending $10 gets about 700 Bits to donate, worth $7 to you. With direct donations, that same $10 becomes $9.41 after PayPal fees.
...
Bits do integrate with Twitch's ecosystem - viewers earn badges and feel part of the platform. But financially, direct donations win every time.`,
    },
    {
      ...
      content: `Twitch uses [Net-15 payments with a $100 minimum](/guides/twitch-payout-delays). Money earned in January arrives mid-February at best - if you hit the threshold. Many small streamers wait months to reach $100.

Streamlabs donations hit your PayPal immediately. You can transfer to your bank in 1-3 days. No waiting for month-end, no minimum threshold. For even faster access, see our guide on [instant payout platforms](/guides/instant-payouts-for-streamers).`,
    },
    {
...
Streamlabs donations through PayPal put the [chargeback risk](/guides/streamer-chargebacks) on you. A disputed $100 donation costs you $100 plus PayPal's $20 fee. This is the biggest downside of PayPal-based donations.`,
    },
    {
...
For the highest revenue with no chargeback risk, consider [instant payout alternatives](/guides/instant-payouts-for-streamers) that offer lower fees than both Twitch and PayPal.`,
    },
  ],
  ...
  faq: [
    {
      ...
      answer:
        'Per dollar spent by viewers, donations pay more. You keep 91% of donations versus 50% of sub revenue. However, subs provide recurring monthly income.',
    },
    {
