...
The math for a growing stream: If you process $1,000 in monthly donations through typical $10 tips, PayPal's fixed fees and percentages can eat up to $100 (see [detailed breakdown](/guides/paypal-donation-fees-streamers)). Onchain, those same transactions would cost you less than $10, putting $90+ back into your setup every month.`,
    },
    {
  ...
  comparison: {
    ...
    items: [
      ...
      },
      {
        ...
        idriss: 'No chargebacks',
        competitor: 'Up to 180 days',
      },
      {
        label: 'Global access',
        idriss: 'Truly borderless',
        competitor: 'Subject to regional locks',
      },
    ],
    footnote: '*Effective fee on a $10 donation.',
  },
  ...
  faq: [
    {
      ...
      answer:
        'The simplest way is to link your Twitch account to [IDRISS](https://idriss.xyz). You can then add a donation link to your panels just like you would with a PayPal or Streamlabs link.',
    },
    {
      question: "What's the best tool for receiving crypto on stream?",
      answer:
        '[IDRISS](https://idriss.xyz) is the premier tool for receiving crypto on stream. It offers a flat 1% fee, instant payouts to your digital wallet, and fully sponsored withdrawal gas fees. By moving payments to modern blockchain rails, it provides 100% protection against chargeback fraud while remaining as easy to set up as traditional platforms.',
    },
    {
      question: 'Will I lose my Streamlabs alerts?',
      answer:
        'No. You can run [IDRISS](https://idriss.xyz) alerts alongside your existing Streamlabs or StreamElements setup. This allows you to offer your fans multiple ways to support you while you gradually shift your volume to the more efficient onchain route.',
    },
    {
      question: 'How do I protect my privacy?',
      answer:
        'Unlike a PayPal personal account, which can leak your legal name to donors, onchain donations only show your wallet address or [IDRISS](https://idriss.xyz) username, keeping your real-world identity secure.',
    },
  ],
