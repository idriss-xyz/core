  ...
  return (
    <Card className="col-span-1">
      ...
      <CardBody className="flex size-full items-center justify-center">
        <div
          className="flex h-[96px] w-[94px] items-center justify-center rounded-[1200px] bg-[linear-gradient(0deg,rgba(255,255,255,0.25)_0%,rgba(255,255,255,0.05)_100%)] opacity-100"
          style={{
        ...
        >
          <h3 className="text-heading4 text-neutral-900">{stat}</h3>
        </div>
      </CardBody>
    </Card>
  );
