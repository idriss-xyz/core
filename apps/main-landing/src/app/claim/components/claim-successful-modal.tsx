      ...
      <>
        <div className="mt-5 flex flex-col items-center gap-6 self-stretch rounded-lg border border-neutral-200 bg-mint-100 p-6">
          <div className="relative flex w-full flex-row justify-center">
            <img className="size-[83px]" src={idrissCoin.src} />
            <Icon
              name="Download"
              size={24}
              className="absolute right-0 top-0 flex size-6"
            />
          </div>
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex flex-col items-center justify-center rounded-[12px] border-[0.683px] border-[rgba(85,235,60,0.30)] bg-[radial-gradient(50%_50%_at_50%_50%,_rgba(252,255,242,0.00)_0%,_rgba(23,255,74,0.18)_100%)] p-[22px]">
