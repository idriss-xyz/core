...
export const LetterContent = () => {
  ...
  return (
    <div className="z-[5] inline-flex flex-col items-center gap-4 overflow-hidden px-4 pb-3 pt-6">
      <div className="relative flex w-[600px] flex-col items-center gap-10 rounded-[25px] bg-[rgba(255,255,255,0.5)] p-10 backdrop-blur-[45px]">
        <GradientBorder
        ...
        <div className="relative flex w-full flex-col items-center gap-2 rounded-[25px] bg-[rgba(255,255,255,0.2)] px-10 py-8">
          ...
          <div className="flex flex-col gap-6 text-body5 text-neutralGreen-700">
            ...
            <span>
              Lorem ipsum dolor sit amet consectetur. At duis arcu ultricies
              risus aliquam. At consequat faucibus eget ultrices. Aliquet duis
              aliquam sagittis vel eget praesent. Enim orci elit nullam sit arcu
              ornare donec quis semper.
            </span>
            <span>Onwards!</span>
