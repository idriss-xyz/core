          ...
          <>
            ...
            >
                ...
                <>
                  <div className="flex flex-col gap-[10px] px-6 py-4">
                    <div className="flex flex-col gap-1">
                      <span className={classes("text-label4")}>Selected asset</span>
                      <div className={classes("flex flex-row items-center gap-[10px] text-label4")}>
                        <div className="h-6">
                          <TokenLogo symbol={tokenSymbol} />
                        </div>
                        <span className={classes("text-body4 text-neutralGreen-900")}>
                          {tokenSymbol}
                        </span>
                        <span className="hidden">{tokenAddress}</span>{' '}
                        <span className={classes("rounded-[4px] bg-mint-200 px-1 text-label6 text-mint-700")}>
                          {formatFiatValue(amount)}
                        </span>
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                      ...
                      <div className={classes("flex flex-row gap-[10px] text-label4")}>
                        <img
              ...
              <div className="border-t border-t-neutral-300 px-4 py-3">
                ...
                {formError && (
                  <div className={classes("mt-1 flex items-start gap-x-1 text-label7 text-red-500 lg:text-label6")}>
