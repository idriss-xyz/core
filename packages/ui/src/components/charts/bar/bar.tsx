...
function ChartTooltipContent({
  ...
  React.ComponentProps<"div"> & {
    ...
    labelKey?: string
    label?: string
    payload?: Array<{ name?: string; dataKey?: string; value?: number; color?: string; payload?: any }>
  }) {
  ...
  const tooltipLabel = useMemo(() => {
    ...
    return <div className={classes("font-medium", labelClassName)}>{value}</div>
  }, [
    label,
    labelFormatter,
    tooltipPayload,
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {tooltipPayload.map((item: { name?: string; dataKey?: string; value?: number; color?: string; payload?: any }, index: number) => {
