...
export class RenameAlertToggles1752674138685 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "donation_parameters" RENAME COLUMN "alert_muted" TO "alert_enabled"`,
    );
    await queryRunner.query(
      `ALTER TABLE "donation_parameters" RENAME COLUMN "tts_muted" TO "tts_enabled"`,
    );
    await queryRunner.query(
      `ALTER TABLE "donation_parameters" RENAME COLUMN "sfx_muted" TO "sfx_enabled"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "donation_parameters" RENAME COLUMN "alert_enabled" TO "alert_muted"`,
    );
    await queryRunner.query(
      `ALTER TABLE "donation_parameters" RENAME COLUMN "tts_enabled" TO "tts_muted"`,
    );
    await queryRunner.query(
      `ALTER TABLE "donation_parameters" RENAME COLUMN "sfx_enabled" TO "sfx_muted"`,
    );
