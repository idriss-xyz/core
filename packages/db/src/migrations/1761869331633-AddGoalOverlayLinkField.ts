...
export class AddGoalOverlayLinkField1761869331633
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "creator" ADD COLUMN "goal_url" text NULL;`,
    );

    await queryRunner.query(`
      UPDATE "creator"
      SET goal_url = REPLACE(obs_url, 'alert-overlay', 'goal-overlay')
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "creator" DROP COLUMN "goal_url";`);
